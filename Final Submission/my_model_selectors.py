        ...
        for num_states in range(self.min_n_components,self.max_n_components+1):
            ...
            if hmm_model is not None:
                try:
                    ...
                    p = (num_states*(num_states-1)) + num_states + 2*num_states*(len(self.X[0]))
                    N = 0
                    ...
                    BIC = 0
            component_model_scores.loc[num_states-self.min_n_components] = [num_states, BIC]
        component_model_scores = component_model_scores[component_model_scores['mean_log_likelihood'] != 0]
        # Best model parameters
        try:
            best_num_states = \
                component_model_scores.ix[component_model_scores[['mean_log_likelihood']].idxmin()]['components_num']
